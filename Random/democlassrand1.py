...
# Initialize a list to store STFT features for each task
stft_features = []

# Load EEG data for each task and calculate STFT features
...
# Reshape the STFT features array to have a single dimension for each task
